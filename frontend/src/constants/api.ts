...
export const articleUrlsMap = {
  ARTICLE_GET_NEWS_URL: (userId: string) =>
    generatePathParamURL(`${BASE_ARTICLE_API_URL}/new`, userId),
  ARTICLE_GET_ARCHIVED_URL: (userId: string) =>
    generatePathParamURL(`${BASE_ARTICLE_API_URL}/archive`, userId),
  ARTICLE_POST_ADD_ARCHIVE_URL: (userId: string) =>
    generatePathParamURL(`${BASE_ARTICLE_API_URL}/new`, userId),
  ARTICLE_POST_DELETE_URL: (userId: string) =>
    generatePathParamURL(`${BASE_ARTICLE_API_URL}/article`, userId),
};
